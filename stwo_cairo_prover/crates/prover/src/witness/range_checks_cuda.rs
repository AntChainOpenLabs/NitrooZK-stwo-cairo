//! CUDA-compatible range checks claim generator.
//!
//! This module provides a CUDA-accelerated range checks generator that uses CUDA
//! for components with CUDA implementations (rc_11, rc_18, rc_7_2_5) and falls back
//! to SIMD for other range check components.
...
pub struct RangeChecksCudaClaimGenerator {
    ...
    // CUDA generator for rc_11
    pub rc_11_trace_generator: range_check_11_cuda::CudaClaimGenerator,
    // SIMD generator for rc_11 (for SIMD components)
    pub rc_11_simd_trace_generator: range_check_11::ClaimGenerator,
    pub rc_12_trace_generator: range_check_12::ClaimGenerator,
    // CUDA generator for rc_18
    pub rc_18_trace_generator: range_check_18_cuda::CudaClaimGenerator,
    // SIMD generator for rc_18 (for SIMD components)
    pub rc_18_simd_trace_generator: range_check_18::ClaimGenerator,
    ...
    // CUDA generator for rc_7_2_5
    pub rc_7_2_5_trace_generator: range_check_7_2_5_cuda::CudaClaimGenerator,
    // SIMD generator for rc_7_2_5 (for SIMD components)
    pub rc_7_2_5_simd_trace_generator: range_check_7_2_5::ClaimGenerator,
...
impl Default for RangeChecksCudaClaimGenerator {
    fn default() -> Self {
        Self::new()
    }
}
...
impl RangeChecksCudaClaimGenerator {
    pub fn new() -> Self {
        Self {
            ...
            // CUDA generator for rc_11
            rc_11_trace_generator: range_check_11_cuda::CudaClaimGenerator::new_rc_11(),
            // SIMD generator for rc_11 (for SIMD components)
            rc_11_simd_trace_generator: range_check_11::ClaimGenerator::new(),
            rc_12_trace_generator: range_check_12::ClaimGenerator::new(),
            // CUDA generator for rc_18
            rc_18_trace_generator: range_check_18_cuda::CudaClaimGenerator::new_rc_18(),
            // SIMD generator for rc_18 (for SIMD components)
            rc_18_simd_trace_generator: range_check_18::ClaimGenerator::new(),
            ...
            // CUDA generator for rc_7_2_5
            rc_7_2_5_trace_generator: range_check_7_2_5_cuda::CudaClaimGenerator::new_rc_7_2_5(),
            // SIMD generator for rc_7_2_5 (for SIMD components)
            rc_7_2_5_simd_trace_generator: range_check_7_2_5::ClaimGenerator::new(),
    ...
    pub fn write_trace(
        ...
        // SIMD write_trace for components without CUDA implementations
        ...
        // Use SIMD generator for rc_11 (accumulates multiplicities from SIMD components)
        let (rc_11_claim, rc_11_interaction_gen) =
            self.rc_11_simd_trace_generator.write_trace(tree_builder);
        let (rc_12_claim, rc_12_interaction_gen) =
            self.rc_12_trace_generator.write_trace(tree_builder);
        // Use SIMD generator for rc_18 (accumulates multiplicities from SIMD components)
        let (rc_18_claim, rc_18_interaction_gen) =
            self.rc_18_simd_trace_generator.write_trace(tree_builder);
        ...
        // Use SIMD generator for rc_7_2_5 (accumulates multiplicities from SIMD components)
        let (rc_7_2_5_claim, rc_7_2_5_interaction_gen) =
            self.rc_7_2_5_simd_trace_generator.write_trace(tree_builder);
...
pub struct RangeChecksCudaInteractionClaimGenerator {
    ...
    // SIMD interaction generator for rc_11 (to match SIMD trace generator)
    ...
    // SIMD interaction generator for rc_18 (to match SIMD trace generator)
    ...
    // SIMD interaction generator for rc_7_2_5 (to match SIMD trace generator)
...
impl RangeChecksCudaInteractionClaimGenerator {
    pub fn write_interaction_trace(
        ...
        // SIMD interaction trace for rc_11
        ...
        // SIMD interaction trace for rc_18
        ...
        // SIMD interaction trace for rc_7_2_5
