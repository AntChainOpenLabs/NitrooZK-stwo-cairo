use cairo_air::components::range_check_9_9::{Claim, InteractionClaim};
...
pub const RANGES: [u32; 2] = [9, 9];
pub const N_RELATIONS: usize = 8;

/// Relation constants from the AIR definition (range_check_9_9.rs).
...
pub struct CudaClaimGenerator(CudaMultiRelationRangeCheckGenerator<2, N_RELATIONS>);
...
pub struct InteractionClaimGeneratorCuda(CudaMultiRelationInteractionGen<2, N_RELATIONS>);
