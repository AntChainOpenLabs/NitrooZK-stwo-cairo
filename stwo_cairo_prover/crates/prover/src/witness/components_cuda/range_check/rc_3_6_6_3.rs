...
use cairo_air::components::range_check_3_6_6_3::{Claim, InteractionClaim};
...
pub const RANGES: [u32; 4] = [3, 6, 6, 3];

const RELATION_CONSTANT: M31 = M31(1005786011);
...
pub struct InteractionClaimGeneratorCuda(CudaInteractionClaimGeneratorCuda<4>);
