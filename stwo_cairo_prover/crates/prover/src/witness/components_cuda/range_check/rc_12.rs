...
use cairo_air::components::range_check_12::{Claim, InteractionClaim};
...
pub const RANGES: [u32; 1] = [12];

const RELATION_CONSTANT: M31 = M31(941275232);
...
pub struct InteractionClaimGeneratorCuda(CudaInteractionClaimGeneratorCuda<1>);
