//! CUDA implementation for range_check_18 component.
//!
//! This module provides a CUDA-accelerated claim generator for 18-bit range checks.
...
/// Input type for CUDA range check: single 18-bit value
pub type CudaPackedInputType = [BaseFieldVec; 1];

/// Range configuration: single 18-bit segment
pub const RANGES: [u32; 1] = [18];

/// CUDA claim generator for rc_18 (newtype wrapper)
pub struct CudaClaimGenerator(CudaRangeCheckGenerator<1>);

impl CudaClaimGenerator {
    /// Create a new CUDA claim generator for rc_18
    pub fn new_rc_18() -> Self {
...
/// Interaction claim generator for rc_18
...
impl InteractionClaimGenerator {
    pub fn write_interaction_trace(
        &self,
        tree_builder: &mut impl TreeBuilder<SimdBackend>,
        lookup_elements: &relations::RangeCheck_18,
    ) -> InteractionClaim {
