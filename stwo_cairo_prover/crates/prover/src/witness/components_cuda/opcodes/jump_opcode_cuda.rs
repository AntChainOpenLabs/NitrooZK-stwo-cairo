#![allow(unused_parens)]
use cairo_air::components::jump_opcode_abs::{Claim, InteractionClaim};
...
const CUDA_N_TRACE_COLUMNS: usize = 15;
...
impl CudaClaimGenerator {
    ...
    pub fn write_trace(
        ...
        // CUDA kernel generates 15 columns but AIR expects 14. The extra column is at
