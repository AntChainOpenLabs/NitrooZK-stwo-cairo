...
const CUDA_N_TRACE_COLUMNS: usize = 17;
...
impl CudaClaimGenerator {
    ...
    pub fn write_trace(
        ...
        // CUDA kernel generates 17 columns but AIR expects 16. The extra column is at
        // CUDA index 5 (op1_base_ap, not used by the current AIR). Extract all except 5.
        const EXTRA_COL_IDX: usize = 5;
