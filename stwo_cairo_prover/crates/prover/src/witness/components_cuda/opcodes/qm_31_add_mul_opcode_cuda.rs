...
impl CudaClaimGenerator {
    ...
    pub fn write_trace(
        ...
        range_check_4_4_4_4_cuda_state.add_cuda_inputs(&sub_component_inputs.range_check_4_4_4_4);
...
fn write_trace_cuda(
    ...
    let sub_component_inputs_range_check_4_4_4_4_vec =
        collect_sub_input_ptrs!(sub_component_inputs, range_check_4_4_4_4);
    ...
    pub fn write_interaction_trace(
        ...
        unsafe {
            ...
            bindings_airs::generate_qm_31_add_mul_opcode_interaction_traces(
                ...
                &mod_rc4444 as *const _ as *mut std::os::raw::c_void,
