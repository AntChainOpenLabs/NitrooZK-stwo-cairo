...
use super::super::{
    memory_address_to_id_cuda, memory_id_to_big_cuda, range_check_11_cuda, verify_instruction_cuda,
};
...
impl CudaClaimGenerator {
    ...
    pub fn write_trace(
        ...
        range_check_11_cuda_state.add_cuda_inputs(&sub_component_inputs.range_check_11);
...
pub struct CudaSubComponentInputs {
    ...
    pub memory_id_to_big: [memory_id_to_big_cuda::CudaPackedInputType; 3],
...
fn write_trace_cuda(
    ...
    let sub_component_inputs_range_check_11_vec =
        collect_sub_input_ptrs!(sub_component_inputs, range_check_11);
    ...
    pub fn write_interaction_trace(
        ...
        unsafe {
            ...
            bindings_airs::generate_mul_opcode_small_interaction_traces(
                ...
                &mod_rc11 as *const _ as *mut std::os::raw::c_void, // range_check_11
