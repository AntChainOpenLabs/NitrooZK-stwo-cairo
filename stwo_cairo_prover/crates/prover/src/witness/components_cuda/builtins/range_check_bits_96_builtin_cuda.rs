// CUDA witness generation for range_check96_builtin component
// This handles 96-bit range check operations

#![allow(unused_parens)]
use cairo_air::components::range_check96_builtin::{Claim, InteractionClaim};
...
use super::super::range_check::rc_6;
...
impl CudaClaimGenerator {
    ...
    pub fn write_trace(
        ...
        range_check_6_cuda_state: &rc_6::CudaClaimGenerator,
        ...
        // Add to CUDA generators - memory SIMD multiplicities are handled by the merge in
        // cairo_cuda.rs
        ...
        // Add range_check_6 inputs directly to CUDA generator
        range_check_6_cuda_state.add_cuda_inputs(&sub_component_inputs.range_check_6);
        ...
        (
            Claim {
                log_size,
                range_check96_builtin_segment_start: self.segment_start,
            },
...
fn write_trace_cuda(
    ...
    let (trace, lookup_data, sub_component_inputs) = unsafe {
        (
            ...
            CudaSubComponentInputs {
                ...
                range_check_6: std::array::from_fn(|_| {
                    std::array::from_fn(|_| BaseFieldVec::uninitialized(1 << log_size))
                }),
            },
        )
    ...
    let sub_inputs_range_check_6: Vec<_> = sub_component_inputs
        .range_check_6
        .iter()
        .flat_map(|row| row.iter().map(|x| x.device_ptr))
        .collect();
...
impl CudaInteractionClaimGenerator {
    pub fn write_interaction_trace(
        ...
        unsafe {
            ...
            let mod_rc6 =
                create_modified_lookup_for_cuda(lookup_elements, RANGE_CHECK_6_RELATION_ID);
            ...
            bindings_airs::generate_range_check_builtin_bits_96_interaction_traces(
                ...
                &mod_rc6 as *const _ as *mut std::os::raw::c_void,
                lookup_memory_address_to_id_0.as_ptr(),
                lookup_memory_id_to_big_0.as_ptr(),
                lookup_range_check_6_0.as_ptr(),
                self.n_rows as u32,
