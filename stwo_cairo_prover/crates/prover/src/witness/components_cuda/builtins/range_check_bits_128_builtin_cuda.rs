// CUDA witness generation for range_check_builtin_bits_128 component
// This handles 128-bit range check operations

#![allow(unused_parens)]
use cairo_air::components::range_check_builtin_bits_128::{Claim, InteractionClaim};
...
impl CudaClaimGenerator {
    ...
    pub fn write_trace(
        ...
        (
            Claim { log_size, range_check_builtin_segment_start: self.segment_start },
...
pub mod tests {
    ...
    #[test]
    fn test_range_check_bits_128_builtin_cpu_ref() {
        use cairo_air::relations;
        use cairo_air::components::range_check_builtin_bits_128::{Component, Eval};
        ...
        // Load test program
        let compiled_program = get_compiled_cairo_program_path("test_prove_verify_range_check_bits_128_builtin");
        let input = run_program_and_adapter(&compiled_program, ProgramType::Json, None);

        // Check for range_check_bits_128 builtin segment
        use stwo_cairo_adapter::builtins::RANGE_CHECK_MEMORY_CELLS;

        let range_check128_segment = input.builtin_segments.range_check_bits_128.as_ref()
            .expect("Expected range_check_bits_128 builtin segment");

        let segment_length = range_check128_segment.stop_ptr - range_check128_segment.begin_addr;
        let n_instances = segment_length / RANGE_CHECK_MEMORY_CELLS;
        let log_size = n_instances.ilog2();
        let segment_start = range_check128_segment.begin_addr as u32;

        println!("range_check_bits_128_builtin log_size: {}, segment_start: {}", log_size, segment_start);
        ...
        // Create range_check_bits_128_builtin claim generator
        let range_check128_claim_gen = range_check_builtin_bits_128::ClaimGenerator::new(log_size, segment_start);
        ...
        // Base trace
        let mut mock_tree_builder = mock_commitment_scheme.tree_builder();
        let (range_check128_claim, range_check128_interaction_gen) = range_check128_claim_gen.write_trace(
        ...
        println!("range_check_bits_128_builtin_claim log_size: {:?}", range_check128_claim.log_size);

        // Interaction trace
        let mut mock_tree_builder = mock_commitment_scheme.tree_builder();
        let range_check128_interaction_claim = range_check128_interaction_gen.write_interaction_trace(
            &mut mock_tree_builder,
        ...
        println!("range_check_bits_128_builtin_interaction_claim.claimed_sum: {:?}", range_check128_interaction_claim.claimed_sum);

        // Create component and verify with assert_component
        let tree_span_provider = &mut TraceLocationAllocator::default();
        let range_check128_component = Component::new(
            tree_span_provider,
            Eval {
                eval_id: fnv1a_eval_id_gen("range_check_builtin_bits_128"),
                claim: range_check128_claim.clone(),
                memory_address_to_id_lookup_elements: relations::MemoryAddressToId::dummy(),
                memory_id_to_big_lookup_elements: relations::MemoryIdToBig::dummy(),
            },
            range_check128_interaction_claim.claimed_sum,
        );

        assert_component(&range_check128_component, &trace)
    }

    /// Compare CPU and CUDA traces column by column to identify discrepancies.
    #[test]
    fn test_range_check_bits_128_builtin_compare_cpu_vs_cuda_traces() {
        use stwo_cairo_common::preprocessed_columns::preprocessed_trace::testing_preprocessed_tree;
        ...
        let range_check128_claim_gen_cpu = range_check_builtin_bits_128::ClaimGenerator::new(log_size, segment_start);
        ...
        let mut mock_tree_builder_cpu = mock_commitment_scheme_cpu.tree_builder();
        let (cpu_claim, _cpu_interaction_gen) = range_check128_claim_gen_cpu.write_trace(
        ...
        let range_check128_cuda_gen = CudaClaimGenerator::new(log_size, segment_start);
        ...
        let mut mock_tree_builder_cuda = mock_commitment_scheme_cuda.tree_builder();
        let (cuda_claim, _cuda_interaction_gen) = range_check128_cuda_gen.write_trace(
    ...
    #[test]
    fn test_range_check_bits_128_builtin_trace_gen_by_cuda_and_verify_by_cpu() {
        use cairo_air::relations;
        use cairo_air::components::range_check_builtin_bits_128::{Component, Eval};
        use stwo_constraint_framework::TraceLocationAllocator;
        use stwo_cairo_common::preprocessed_columns::preprocessed_trace::testing_preprocessed_tree;
        ...
        // Base trace (CUDA)
        let mut mock_tree_builder = mock_commitment_scheme.tree_builder();
        let (range_check128_claim, range_check128_interaction_gen) = range_check128_cuda_gen.write_trace(
            &mut mock_tree_builder,
            &mut memory_address_to_id_cuda_state,
            &memory_id_to_big_cuda_state,
            &memory_address_to_id_simd_state,
        ...
        assert_component(&range_check128_component, &trace);
        println!("range_check_bits_128_builtin CUDA trace gen + CPU verify test completed successfully!");
    }
}
