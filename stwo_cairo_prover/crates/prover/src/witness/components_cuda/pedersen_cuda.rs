...
//! Uses RangeChecksCudaClaimGenerator instead of RangeChecksClaimGenerator.
...
impl Default for PedersenContextCudaClaimGenerator {
    fn default() -> Self {
        Self::new()
    }
}
...
impl PedersenContextCudaClaimGenerator {
    ...
    pub fn write_trace(
        ...
        PedersenContextCudaInteractionClaimGenerator,
    ) {
        ...
        if self.partial_ec_mul_trace_generator.is_empty() {
            return (
                ...
                PedersenContextCudaInteractionClaimGenerator { gen: None },
            );
        }
        ...
        (
            ...
            PedersenContextCudaInteractionClaimGenerator { gen },
        )
    }
}
