...
pub struct LookupData {
    pub blake_round_0: Vec<[PackedM31; 35]>,
    pub blake_round_1: Vec<[PackedM31; 35]>,
    pub memory_address_to_id_0: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_1: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_2: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_3: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_4: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_5: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_6: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_7: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_8: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_9: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_10: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_11: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_12: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_13: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_14: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_15: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_16: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_17: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_18: Vec<[PackedM31; 2]>,
    pub memory_address_to_id_19: Vec<[PackedM31; 2]>,
    pub memory_id_to_big_0: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_1: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_2: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_3: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_4: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_5: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_6: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_7: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_8: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_9: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_10: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_11: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_12: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_13: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_14: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_15: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_16: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_17: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_18: Vec<[PackedM31; 29]>,
    pub memory_id_to_big_19: Vec<[PackedM31; 29]>,
    pub opcodes_0: Vec<[PackedM31; 3]>,
    pub opcodes_1: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_0: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_1: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_2: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_3: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_4: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_5: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_6: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_7: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_8: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_9: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_10: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_11: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_12: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_13: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_14: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_15: Vec<[PackedM31; 3]>,
    pub range_check_7_2_5_16: Vec<[PackedM31; 3]>,
    pub triple_xor_32_0: Vec<[PackedM31; 8]>,
    pub triple_xor_32_1: Vec<[PackedM31; 8]>,
    pub triple_xor_32_2: Vec<[PackedM31; 8]>,
    pub triple_xor_32_3: Vec<[PackedM31; 8]>,
    pub triple_xor_32_4: Vec<[PackedM31; 8]>,
    pub triple_xor_32_5: Vec<[PackedM31; 8]>,
    pub triple_xor_32_6: Vec<[PackedM31; 8]>,
    pub triple_xor_32_7: Vec<[PackedM31; 8]>,
    pub verify_bitwise_xor_8_0: Vec<[PackedM31; 3]>,
    pub verify_bitwise_xor_8_1: Vec<[PackedM31; 3]>,
    pub verify_bitwise_xor_8_2: Vec<[PackedM31; 3]>,
    pub verify_bitwise_xor_8_3: Vec<[PackedM31; 3]>,
    pub verify_instruction_0: Vec<[PackedM31; 7]>,
}
...
impl InteractionClaimGenerator {
    #[cfg(test)]
    pub fn lookup_data(&self) -> &LookupData {
        &self.lookup_data
    }
