...
//!
//! This module provides `OpcodesCudaClaimGenerator` which uses CUDA for opcode trace generation.
//! It completely replaces `OpcodesClaimGenerator` when running in CUDA mode.
...
/// Local grouped claim type (mirrors legacy `cairo_air::opcodes_air::OpcodeClaim`).
...
use super::components_cuda::opcodes::{
    add_ap_opcode_cuda, add_opcode_cuda, add_opcode_small_cuda, assert_eq_opcode_cuda,
    assert_eq_opcode_double_deref_cuda, assert_eq_opcode_imm_cuda, blake_compress_opcode_cuda,
    call_opcode_cuda, call_opcode_rel_imm_cuda, generic_opcode_cuda, jnz_opcode_cuda,
    jnz_opcode_taken_cuda, jump_opcode_cuda, jump_opcode_double_deref_cuda, jump_opcode_rel_cuda,
    jump_opcode_rel_imm_cuda, mul_opcode_cuda, mul_opcode_small_cuda, qm_31_add_mul_opcode_cuda,
    ret_opcode_cuda,
};
...
impl OpcodesCudaClaimGenerator {
    ...
    pub fn write_trace(
        ...
        range_checks_trace_generator: &super::range_checks_cuda::RangeChecksCudaClaimGenerator,
        blake_round_cuda: &mut Option<super::components_cuda::blake_round_cuda::CudaClaimGenerator>,
        triple_xor_32_cuda: &mut Option<
            super::components_cuda::triple_xor_32_cuda::CudaClaimGenerator,
        >,
        vbx_8_cuda: &Option<super::components_cuda::vbx_8_cuda::CudaClaimGenerator>,
