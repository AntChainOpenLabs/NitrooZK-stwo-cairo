...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let enabler_col129 = eval.next_trace_mask();

        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [decode_instruction_4b8cf_output_tmp_42314_11_offset0, decode_instruction_4b8cf_output_tmp_42314_11_offset1, decode_instruction_4b8cf_output_tmp_42314_11_offset2, decode_instruction_4b8cf_output_tmp_42314_11_op1_base_ap] =
        ...
        eval.add_constraint(
            (op1_imm_col8.clone()
                * (M31_1.clone() - decode_instruction_4b8cf_output_tmp_42314_11_offset2.clone())),
        );
        // mem_dst_base.
        eval.add_constraint(
        ...
        eval.add_constraint(
            (mem1_base_col13.clone()
                - (((op1_imm_col8.clone() * input_pc_col0.clone())
                    ...
                    + (decode_instruction_4b8cf_output_tmp_42314_11_op1_base_ap.clone()
                        * input_ap_col1.clone()))),
        );
        ReadPositiveNumBits252::evaluate(
            [(mem_dst_base_col11.clone()
                + decode_instruction_4b8cf_output_tmp_42314_11_offset0.clone())],
            dst_id_col14.clone(),
        ...
        ReadPositiveNumBits252::evaluate(
            [(mem0_base_col12.clone()
                + decode_instruction_4b8cf_output_tmp_42314_11_offset1.clone())],
            op0_id_col43.clone(),
        ...
        ReadPositiveNumBits252::evaluate(
            [(mem1_base_col13.clone()
                + decode_instruction_4b8cf_output_tmp_42314_11_offset2.clone())],
            op1_id_col72.clone(),
        ...
        VerifyMul252::evaluate(
            ...
            k_col101.clone(),
            carry_0_col102.clone(),
            carry_1_col103.clone(),
            carry_2_col104.clone(),
            carry_3_col105.clone(),
            carry_4_col106.clone(),
            carry_5_col107.clone(),
            carry_6_col108.clone(),
            carry_7_col109.clone(),
            carry_8_col110.clone(),
            carry_9_col111.clone(),
            carry_10_col112.clone(),
            carry_11_col113.clone(),
            carry_12_col114.clone(),
            carry_13_col115.clone(),
            carry_14_col116.clone(),
            carry_15_col117.clone(),
            carry_16_col118.clone(),
            carry_17_col119.clone(),
            carry_18_col120.clone(),
            carry_19_col121.clone(),
            carry_20_col122.clone(),
            carry_21_col123.clone(),
            carry_22_col124.clone(),
            carry_23_col125.clone(),
        ...
        // Enabler is a bit.
        eval.add_constraint(
            ((enabler_col129.clone() * enabler_col129.clone()) - enabler_col129.clone()),
        );
        eval.add_to_relation(RelationEntry::new(
            &self.common_lookup_elements,
            E::EF::from(enabler_col129.clone()),
            &[
                M31_428564188.clone(),
                input_pc_col0.clone(),
                input_ap_col1.clone(),
...
mod tests {
    ...
    fn mul_opcode_constraints_regression() {
        ...
        MUL_OPCODE.assert_debug_eq(&sum);
    }
}
