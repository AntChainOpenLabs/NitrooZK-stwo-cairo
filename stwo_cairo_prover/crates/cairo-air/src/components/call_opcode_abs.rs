...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let enabler_col24 = eval.next_trace_mask();
        ...
        // Enabler is a bit.
        eval.add_constraint(
            ((enabler_col24.clone() * enabler_col24.clone()) - enabler_col24.clone()),
        );
        eval.add_to_relation(RelationEntry::new(
            &self.common_lookup_elements,
            E::EF::from(enabler_col24.clone()),
            &[
                M31_428564188.clone(),
                input_pc_col0.clone(),
                input_ap_col1.clone(),
...
mod tests {
    ...
    fn call_opcode_abs_constraints_regression() {
        ...
        CALL_OPCODE_ABS.assert_debug_eq(&sum);
    }
}
