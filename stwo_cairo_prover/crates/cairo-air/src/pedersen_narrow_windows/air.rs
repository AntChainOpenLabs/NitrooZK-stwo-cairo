...
use crate::components::{
    indented_component_display, partial_ec_mul_window_bits_9, pedersen_aggregator_window_bits_9,
...
pub struct Components {
    pub pedersen_aggregator: pedersen_aggregator_window_bits_9::Component,
    pub partial_ec_mul: partial_ec_mul_window_bits_9::Component,
    pub pedersen_points_table: pedersen_points_table_window_bits_9::Component,
}
impl Components {
    fn new(
        tree_span_provider: &mut TraceLocationAllocator,
        ...
        let pedersen_aggregator_component = pedersen_aggregator_window_bits_9::Component::new(
            tree_span_provider,
            pedersen_aggregator_window_bits_9::Eval {
                claim: cairo_claim.pedersen_aggregator_window_bits_9.unwrap(),
        ...
        let partial_ec_mul_component = partial_ec_mul_window_bits_9::Component::new(
            tree_span_provider,
            partial_ec_mul_window_bits_9::Eval {
                claim: cairo_claim.partial_ec_mul_window_bits_9.unwrap(),
                common_lookup_elements: common_lookup_elements.clone(),
            },
            interaction_claim
        ...
        let pedersen_points_table_component = pedersen_points_table_window_bits_9::Component::new(
            tree_span_provider,
            pedersen_points_table_window_bits_9::Eval {
                claim: cairo_claim.pedersen_points_table_window_bits_9.unwrap(),
                common_lookup_elements: common_lookup_elements.clone(),
            },
            interaction_claim
                .pedersen_points_table_window_bits_9
